...
class TestLogisticsGO():
    ...
    def test_logistics_go_1(self):
        ...
        HjKjPage(self.driver).click_logistics()
        time.sleep(5)
        ...
        for handle in self.driver.window_handles:
            ...
            if url == "http://gzh.well-healthcare.com/deliverstatus":
                assert "待揽件"==self.driver.find_element(By.XPATH,'//*[@id="postListZone"]/ul/li[2]/a').text
