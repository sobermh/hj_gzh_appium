...
class TestProductListGO():
    ...
    def test_productlist_go_03(self):
        """产品列表的跳转"""
        WeiXinPage(self.driver).click_hjkj()
        HjKjPage(self.driver).click_productcenter()
        HjKjPage(self.driver).click_productlist()
        time.sleep(5)
        ...
        for handle in self.driver.window_handles:
            ...
            if url == "http://gzh.well-healthcare.com/productpage":
                assert 1 ==1
